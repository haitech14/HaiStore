...
export const printerBrands: Brand[] = [
  {
    ...
    logoWidth: 390,
    logoHeight: 80,
    logoClassName: 'max-h-5 w-auto max-w-[5.5rem] object-contain sm:max-h-6',
  },
  {
    name: 'Konica Minolta',
    ...
    logoWidth: 138,
    logoHeight: 80,
    logoClassName: 'max-h-5 w-auto max-w-[4rem] object-contain sm:max-h-6',
  },
  {
    name: 'Canon',
    ...
    logoWidth: 213,
    logoHeight: 80,
    logoClassName: 'max-h-5 w-auto max-w-[4.5rem] object-contain sm:max-h-6',
  },
  {
    name: 'Epson',
  ...
  },
  {
    ...
    logoWidth: 80,
    logoHeight: 80,
    logoClassName: 'h-5 w-5 object-contain sm:h-6 sm:w-6',
  },
  {
    name: 'Kyocera',
  ...
  },
  {
    ...
    logoWidth: 406,
    logoHeight: 80,
    logoClassName: 'max-h-5 w-auto max-w-[6rem] object-contain sm:max-h-6',
  },
  {
    name: 'Oki',
    logo: '/brands/oki.png',
    logoWidth: 182,
    logoHeight: 80,
    logoClassName: 'max-h-5 w-auto max-w-[3.5rem] object-contain sm:max-h-6',
  },
  {
    name: 'Pantum',
  ...
  },
  {
    ...
    logoWidth: 297,
    logoHeight: 80,
    logoClassName: 'max-h-5 w-auto max-w-[5rem] object-contain sm:max-h-6',
  },
  {
    name: 'Ramko',
    ...
    logoWidth: 225,
    logoHeight: 225,
    logoClassName: 'h-6 w-auto max-w-[3.5rem] object-contain sm:h-7 sm:max-w-[4rem]',
  },
  {
    name: 'Topjet',
    ...
    logoWidth: 320,
    logoHeight: 128,
    logoClassName: 'max-h-5 w-auto max-w-[4.75rem] object-contain sm:max-h-6 sm:max-w-[5.25rem]',
  },
  {
    name: 'Densitone',
    ...
    logoWidth: 320,
    logoHeight: 320,
    logoClassName: 'h-6 w-auto max-w-[3.25rem] object-contain sm:h-7 sm:max-w-[3.75rem]',
  },
  {
    name: 'Intercopy',
    ...
    logoWidth: 320,
    logoHeight: 122,
    logoClassName: 'max-h-6 w-auto max-w-[5.75rem] object-contain sm:max-h-7 sm:max-w-[6.5rem]',
  },
  {
    name: 'Katun',
