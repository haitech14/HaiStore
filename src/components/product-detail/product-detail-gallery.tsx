        ...
        {showThumbnails ? (
          <div className="order-2 flex items-center justify-center gap-1.5 sm:order-1 sm:w-[4.75rem] sm:shrink-0 sm:flex-col sm:justify-start">
            <button
              ...
              className="hidden size-7 shrink-0 items-center justify-center rounded-full border border-border bg-white text-muted-foreground transition-colors hover:bg-muted/40 disabled:opacity-40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-600 sm:flex"
            >
            ...
            <button
              ...
              disabled={!canScrollPrev}
              aria-label="Elemento anterior"
              className="flex size-7 shrink-0 items-center justify-center rounded-full border border-border bg-white text-muted-foreground transition-colors hover:bg-muted/40 disabled:opacity-40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-600 sm:hidden"
            >
        ...
        <div className="relative order-1 min-w-0 flex-1 sm:order-2">
          <div
            className={cn(
              ...
              activeIsVideo ? 'aspect-[4/3] sm:aspect-video' : '',
            )}
          >
            {showNuevo ? (
              <div className="absolute left-3 top-3 z-10">
                <ProductNuevoCornerBadge variant="detail" />
              </div>
            ) : null}
            ...
            <div
              className={cn(
                ...
                activeIsVideo ? 'size-full p-0' : 'min-h-[280px] p-4 sm:min-h-[380px] lg:min-h-[420px]',
              )}
            >
              {activeItem?.type === 'video' ? (
                ...
                <button
                  ...
                  className="flex size-full items-center justify-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-600 focus-visible:ring-offset-2"
          ...
          {!activeIsVideo && activeImageSrc ? (
            <button
              type="button"
              onClick={() => setLightboxOpen(true)}
              className="mx-auto mt-3 flex items-center gap-1.5 rounded-full border border-border bg-white px-3 py-1.5 text-xs font-medium text-muted-foreground transition-colors hover:bg-muted/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-600"
            >
