    ...
    >
      ...
      <div className="space-y-5">
        ...
        <InventoryOptionalMerchandisingProducts
          ...
          description="Accesorios o servicios sin ficha en inventario. Aparecen en el carrusel junto a los productos seleccionados."
        ...
        <p className="flex items-start gap-2 rounded-md border border-border/60 bg-muted/15 px-3 py-2 text-xs text-muted-foreground">
          ...
          Los productos de tóner aparecen en el selector del hero; repuestos, accesorios de inventario y

          productos opcionales se suman al total del equipo al pulsar «Agregar al total» en el carrusel.
